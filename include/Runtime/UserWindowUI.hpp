...
namespace spider
{
    class UserWindowUI : public UserType // size and most chacteristics are fixed for now
    {
    public:
        /*
         * Args[0] will have layout, we ignore that for now
         */
        UserWindowUI(spider::UserGraph* gWrap, std::vector<std::string> Args = {}) : UserType(UserType::Type::Window)
        {
